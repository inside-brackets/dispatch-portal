      ...
      <table>
        ...
        <tbody>
              ...
              <label for="mcid">
                {mc
                  ? mc.lenght > 10
                    ...
                    : mc.substring(0, 25)
                  : carrier.mc_file
                  ? carrier.mc_file.lenght > 10
                    ? carrier.mc_file
                    : carrier.mc_file.substring(0, 19)
                  : "No file chosen"}
              </label>
            </td>
            <td>
              {!carrier.mc_file ? (
                <EditButton type="file" onClick={addFile} />
              ) : (
                <div style={{ paddingLeft: "13px" }}>
                  <EditButton type="edit" onClick={addFile} />
                  <EditButton
                    type="eye"
            ...
            <td>
              ...
              <label for="insuranceid">
                {insurance
                  ? insurance.lenght > 10
                    ? insurance
                    : insurance.substring(0, 25)
                  : carrier.insurance_file
                  ? carrier.insurance_file.lenght > 10
                    ? carrier.insurance_file
                    : carrier.insurance_file.substring(0, 19)
                  : "No file chosen"}
              </label>
            </td>
            <td>
              {!carrier.insurance_file ? (
                <EditButton type="file" onClick={addInsuranceFile} />
              ) : (
                <div>
                  <EditButton type="edit" onClick={addInsuranceFile} />
                  <EditButton
                    type="eye"
                    onClick={() => {
                      const pdfWindow = window.open();
          ...
          <tr>
            <td>3</td>
            <td>
              {"props.selectedPayment" === "factoring" ? (
                <>NOA:</>
              ) : (
                <>Void Check</>
              )}
              ...
              <label for="noaid">
                {noa
                  ? noa.lenght > 10
                    ...
                    : noa.substring(0, 25)
                  : carrier.noa_file
                  ? carrier.noa_file.lenght > 10
                    ? carrier.noa_file
                    : carrier.noa_file.substring(0, 19)
                  : "No file chosen"}
              </label>
            </td>
            <td>
              {!carrier.noa_file ? (
                <EditButton type="file" onClick={addnoaFile} />
              ) : (
                <div>
                  <EditButton type="edit" onClick={addnoaFile} />
                  <EditButton
                    type="eye"
                    onClick={() => {
                      const pdfWindow = window.open();
              ...
              <label for="w9id">
                {w9
                  ? w9.lenght > 10
                    ...
                    : w9.substring(0, 25)
                  : carrier.w9_file
                  ? carrier.w9_file.lenght > 10
                    ? carrier.w9_file
                    : carrier.w9_file.substring(0, 19)
                  : "No file chosen"}
              </label>
            </td>
            <td>
              {!carrier.w9_file ? (
                <EditButton type="file" onClick={addw9File} />
              ) : (
                <div>
                  <EditButton type="edit" onClick={addw9File} />
                  <EditButton
                    type="eye"
                    onClick={() => {
                      const pdfWindow = window.open();
